...
import 'publicApi.pb.dart' as $9;

export 'publicApi.pb.dart';

@$pb.GrpcServiceName('pb.PublicApi')
class PublicApiClient extends $grpc.Client {
  static final _$generateJwtQRCodePair = $grpc.ClientMethod<$0.Empty, $9.JwtQRCodePair>(
      '/pb.PublicApi/GenerateJwtQRCodePair',
      ($0.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $9.JwtQRCodePair.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$9.JwtQRCodePair> generateJwtQRCodePair($0.Empty request, {$grpc.CallOptions? options}) {
...
abstract class PublicApiServiceBase extends $grpc.Service {
  ...
  $async.Future<$9.JwtQRCodePair> generateJwtQRCodePair_Pre($grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
    return generateJwtQRCodePair(call, await request);
  }

  $async.Future<$9.JwtQRCodePair> generateJwtQRCodePair($grpc.ServiceCall call, $0.Empty request);
}
