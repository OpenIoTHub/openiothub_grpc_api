...
protoc --Iproto/manager --go_out=pb-go/proto/manager --go-grpc_out=pb-go/proto/manager $(ls ./proto/manager/*.proto)
protoc --Iproto/manager --dart_out=grpc:lib/proto/manager $(ls ./proto/manager/*.proto)